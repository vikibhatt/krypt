...
const Navbar = () =>{
    ...
    return (
        <nav className = "w-full flex md:justfy justify-between items-center p-4">
            ...
            <ul className = "md:flex hidden list-none flex-row justify-between items-center flex-inital">
               <div className = "text-white md:flex hidden list-none flex-row justify-between items-center flex-inital">
            ...
            {toggleMenu && (
                <ul 
                className = "z-10 fixed top-0 -right-2 p-3 w-[50vw] h-screen shadow-2x1 md:hidden list-none flex flex-col justify-start items-end rounded-md blue-glassmorphism text-white animate-slide-in">
